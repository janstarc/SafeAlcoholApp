...
### 2. Add a drink
Here, users can add drinks to the app. When a drink is added, alcohol units and breath alcohol content are calculated. The alcohol content of drinks (button's label text) is only informative - amount and percentage of every drink added can be edited. For the **Custom drink** (last drink on the list) also name can be edited.

<img src="img/Add1.jpg" alt="Add Drink 1"  height="550">
<br><br>

<img src="img/Add2.jpg" alt="Add Drink 2"  height="550">
...
<img src="img/AddFood.jpg" alt="Add Food 1"  height="550">
...
<img src="img/DrinkHistory1.jpg" alt="Drinking history 1"  height="550">
<br><br>

<img src="img/DrinkHistory2.jpg" alt="Drinking history 2"  height="550">
